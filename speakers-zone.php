	            		...
	            		<div class="col-md">
	            			<div class="row align-items-center">
	            				<div class="col-md d-flex align-items-center">
	            					<div class="search_icon_only mr-30">
	            						<button>
		            						<svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
	 											<path fill-rule="evenodd" clip-rule="evenodd" d="M2 8C2 4.68629 4.68629 2 8 2C11.3137 2 14 4.68629 14 8C14 11.3137 11.3137 14 8 14C4.68629 14 2 11.3137 2 8ZM8 0C3.58172 0 0 3.58172 0 8C0 12.4183 3.58172 16 8 16C9.72042 16 11.314 15.4569 12.6187 14.5329L16.7929 18.7071L18.2071 17.2929L14.0956 13.1814C15.2833 11.7855 16 9.97643 16 8C16 3.58172 12.4183 0 8 0Z" fill="#4DC0F1"/>
											</svg>
										</button>
										<div class="input_box search_bar">
											<input type="text">	
										</div>		
	            					</div>
	            					<div class="select_box">
	            						<select>
	            							<option selected="" value="All Stages">All Stages</option>
	            						</select>
	            					</div>
	            				</div>
	            				<div class="col-md">
	            					<div class="tabs_box">
		            					<ul class="tabs_nav_box nav pl-0 d-flex" id="ex1" role="tablist">
										    <li class="nav-item" role="presentation">
												<a class="nav-link active" id="ex1-tab-1" data-mdb-toggle="tab" href="#ex1-tabs-1" role="tab" aria-controls="ex1-tabs-1" aria-selected="true" >Day 1</a>
												</li>
												<li class="nav-item" role="presentation">
												<a class="nav-link" id="ex1-tab-2" data-mdb-toggle="tab" href="#ex1-tabs-2" role="tab" aria-controls="ex1-tabs-2" aria-selected="false">Day 2</a>
												</li>
												<li class="nav-item" role="presentation">
												<a class="nav-link" id="ex1-tab-3" data-mdb-toggle="tab" href="#ex1-tabs-3" role="tab" aria-controls="ex1-tabs-3" aria-selected="false" >Day 3</a>
											</li>
										</ul>
									</div>
	            				</div>
